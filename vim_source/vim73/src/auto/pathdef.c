...
#include "vim.h"
char_u *default_vim_dir = (char_u *)"/home/kren/bin/vim73/share/vim";
...
char_u *all_lflags = (char_u *)"gcc   -L/usr/local/lib -o vim   -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lgdk_pixbuf-2.0 -lpangocairo-1.0 -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lgmodule-2.0 -lglib-2.0   -lXt -lm -lncurses ";
char_u *compiled_user = (char_u *)"kren";
char_u *compiled_sys = (char_u *)"bjfiler1";
